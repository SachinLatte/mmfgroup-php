  ...
  <section class="brands-carousel">
    ...
    <div class="brands-container">
      <div class="brands-carousel1 mt-5">
        ...
        <div class="img-box">
          <img src="img/brands/brand2.webp" alt="dawat rice img" />
        </div>
        <div class="img-box">
          <img src="img/brands/brand3.webp" alt="goldiee masale img" />
        </div>
        <div class="img-box">
          <img src="img/brands/brand4.webp" alt="kalakari img" />
        </div>
        <div class="img-box">
          <img src="img/brands/brand5.webp" alt="jalani img" />
        </div>
        <div class="img-box">
          <img src="img/brands/brand6.webp" alt="salsalito img" />
        </div>
        <div class="img-box">
          <img src="img/brands/brand7.webp" alt="micks img" />
        </div>
        <div class="img-box">
          <img src="img/brands/brand8.webp" alt="happilo img" />
        </div>
      </div>
    </div>
